        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeroImagePublicId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderIndex = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceCards_ServiceSections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectImages_ProjectSections_SectionId",
                        column: x => x.SectionId,
            ...
            migrationBuilder.InsertData(
                table: "Tags",
                columns: new[] { "Id", "NameAr", "NameEn", "OrderIndex", "Slug" },
                values: new object[,]
                {
                    { 1, "تنفيذ تجاري", "Commercial Execution", 0, "commercial" },
                    { 2, "تنفيذ سكني", "Residential Execution", 1, "residential" },
                    { 3, "تصميم", "Design", 2, "design" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectImages_SectionId",
                table: "ProjectImages",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceCards_SectionId",
                table: "ServiceCards",
                column: "SectionId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceSections_Slug",
