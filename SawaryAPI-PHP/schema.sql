-- Sawary API database schema (MySQL / MariaDB)
-- Charset/collation chosen for full Arabic text support.
...
CREATE TABLE IF NOT EXISTS projects (
    ...
    KEY ix_projects_category_id (category_id),
...
-- Seed admin user (username: admin, password: Sawary@2026)
INSERT INTO admin_users (id, username, password_hash, created_at)
VALUES (1, 'admin', '$2a$11$33cMVDQjr.eIkBdXauEcp.O56VnEj/i27T.Yf0njbu/hJ4tX9VK32', UTC_TIMESTAMP())
ON DUPLICATE KEY UPDATE username = username;

-- Seed About/Contact singletons — see migration_about_contact.sql for the full commented
-- explanation of this block; kept byte-for-byte identical here for fresh-install parity.
